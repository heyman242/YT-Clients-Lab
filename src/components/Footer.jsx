        ...
        <div className="flex items-center gap-3">
          {items.map((i) => (
            <a
              ...
              rel="noreferrer"
              aria-label={i.label}
              className="group grid size-12 place-items-center rounded-xl border border-white/15 bg-white/[0.03] text-white/80 transition hover:bg-white/10 hover:text-white"
            >
              {i.icon}
            </a>
          ))}
